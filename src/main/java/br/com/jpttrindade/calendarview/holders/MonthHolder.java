...
public class MonthHolder extends RecyclerView.ViewHolder {
    ...
    public MonthHolder(View itemView, int weekRowsCount, CalendarView.Attributes attrs, CalendarView.OnDayClickListener onDayClickListener) {
        super(itemView);
        ((RecyclerView.LayoutParams) itemView.getLayoutParams()).setMargins(0, 0, 0, Math.round(attrs.monthDividerSize));
        //((RecyclerView.LayoutParams) itemView.getLayoutParams()).setMargins(0,  60, 0,0);
    ...
    public void generateWeekRows() {
        ...
        for (int i = 0; i < weekRowsCount; i++) {
            ...
            layoutParams = new LinearLayout.LayoutParams(
                    ...
                    attrs.dayHeight);
            layoutParams.setMargins(0, Math.round(attrs.dayspace), 0, Math.round(attrs.dayspace));
    ...
    void generateWeekColumns(LinearLayout linearLayout) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            View event_circle1 = container.findViewById(R.id.circle1);
            View event_circle2 = container.findViewById(R.id.circle2);
            ...
            tv_dayValue.setTextSize(attrs.daytextsize);



            event_circle.getLayoutParams().width = Math.round(attrs.eventCircleWidht);
            event_circle.getLayoutParams().height = Math.round(attrs.eventCircleHeight);

            event_circle1.getLayoutParams().width = Math.round(attrs.eventCircleWidht);
            event_circle1.getLayoutParams().height = Math.round(attrs.eventCircleHeight);

            event_circle2.getLayoutParams().width = Math.round(attrs.eventCircleWidht);
            event_circle2.getLayoutParams().height = Math.round(attrs.eventCircleHeight);
...
*/
            ...
            columns[i] = new WeekDayView(container, tv_dayValue, event_circle, today_circle, every_first, blocked, event_circle1, event_circle2);
        }
    ...
    public class WeekDayView {
        ...
        public View blocked;
        public View event_circle1;
        public View event_circle2;


        public WeekDayView(View container, TextView value, View circle, View v_today_circle, View every_first, View blocked, View event_circle1, View event_circle2) {
            this.container = container;
            this.tv_value = value;
            this.blocked = blocked;
            this.v_event_circle = circle;
            this.every_first = every_first;
            this.event_circle1 = event_circle1;
            this.event_circle2 = event_circle2;
